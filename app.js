...
app.get('/admin', adminAuth(['admin', 'boss']),  (req, res) => {
    res.render('account/cuenta/admin');
});

app.get('/admin/inventario', adminAuth(['admin', 'boss']), (req, res) => {
    res.render('account/cuenta/admin/inventory');
});

app.get('/inventario/agregarproduto', adminAuth(['admin', 'boss']), async (req, res) => {
    try {
...
app.get('/inventario/verproducto', adminAuth(['admin', 'boss']), async (req, res) => {
    try {
...
app.get('/inventario/categoria', adminAuth(['admin', 'boss']), async (req, res) => {
    try {
        const categorias = await Categoria.find();
...
app.get('/inventario/editar/:id', adminAuth(['admin', 'boss']), async (req, res) => {
    try {
...
app.get('/inventario/descargarInv', adminAuth(['admin', 'boss']), async (req, res) => {
    try {
        const productos = await iProducto.find();
